...
const TermsOfService: React.FC = () => {
  return (
    <div className="container mx-auto max-w-4xl px-4 py-8">
      ...
      <p className="text-text mb-8">Last updated: October 26, 2023</p>
      ...
      <section className="mb-8">
        ...
        <p className="text-text">
          ...
          account password and are responsible for all activities that occur
      ...
      <section className="mb-8">
        ...
        <p className="text-text">
          You are solely responsible for the content you upload and manage
          through our service. You agree not to upload any content that is
          illegal, misleading, or violates any third party's rights.
        </p>
      </section>
    </div>
  );
