  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <ul className="text-text mt-4 list-inside list-disc">
          <li>
            <strong>Personal Information:</strong> Includes your name, email
            address, and Google account ID.
          </li>
          <li>
            <strong>YouTube Channel Data:</strong> We collect your YouTube
            channel name, channel ID, and other public data to provide our
            services.
          </li>
          <li>
