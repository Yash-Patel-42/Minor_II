    ...
    <div className="min-h-screen bg-neutral-900 p-4 pt-8 text-gray-300 md:p-10">
      <div className="mb-8 border-b border-white/10 pb-6">
        <h1 className="font-display flex items-baseline gap-3 text-5xl font-bold text-white">
          ...
          <span className="font-sans text-lg text-gray-600">({workspace._id})</span>
        </h1>
        <p className="mt-2 max-w-2xl text-lg text-gray-400">{workspace.workspaceDescription}</p>
      </div>
      {workspace.youtubeChannelID ? (
        ...
        >
          ...
          <div className="mb-10 flex flex-wrap gap-4">
            ...
            <motion.button
              onClick={() => navigate(`/workspace/${workspace._id}/permissions`)}
              className="rounded-lg bg-neutral-700 px-5 py-3 font-medium text-gray-300 ring-1 ring-neutral-600 transition-all hover:bg-neutral-600 hover:text-white"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
          ...
          <div className="mb-12 grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-2xl bg-neutral-800 p-6 shadow-xl ring-1 ring-white/10">
              ...
              <p className="text-lg text-gray-300">{workspace.youtubeChannelID.channelName}</p>
              <p className="text-sm text-gray-500">ID: {workspace.youtubeChannelID.channelID}</p>
              <p className="text-sm text-gray-500">{workspace.youtubeChannelID.channelEmail}</p>
            </div>
          </div>
          <div className="grid gap-10 lg:grid-cols-3">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-10 rounded-2xl bg-neutral-800 p-6 shadow-xl ring-1 ring-white/10">
                <h3 className="font-display mb-4 text-2xl font-semibold text-white">Add Member</h3>
                <form onSubmit={addUserToWorkspace} className="flex flex-col gap-4 text-gray-300">
                  <div>
        ...
        >
          ...
          <p className="mt-2 max-w-lg text-lg text-gray-400">
            To manage members, upload videos, and use this workspace, you must first authenticate
